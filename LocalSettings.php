	...
	'wgCreateWikiCannedResponses' => [
		'default' => [
			...
			'Decline reasons' => [
				...
				'Database exists (unrelated purpose)' => 'Wiki database name and subdomain already exist. The wiki does not however seem to have the same purpose as the one you are requesting here, so please select a different subdomain to reopen this request for consideration.',
				...
				'Content Policy (violence or hatred)' => 'Declining per Content Policy provision, "Miraheze does not host wikis that promote violence, hatred, or harassment against a person or group of people." Thank you for your understanding.',
